...
//		Job j1 = new TestJobObject(20, "J1");
//		Job j2 = new TestJobObject(20, "J2");
...
//		SchedulerServiceImpl sched = new SchedulerServiceImpl();
//		Job jj1 = new TestJobObject(20, "JJ1",0l);
//		Job jj2 = new TestJobObject(20, "JJ2", 10l);
//		sched.startExecute(1);
//		sched.enqueue(jj1);
//		sched.enqueue(jj2);
//		WorkerThread t1 = sched.getWorkerThreads()[0];
...
//		SchedulerServiceImpl sched = new SchedulerServiceImpl();
//		Job j1 = new TestJobObject(20, "J1", 10l);
//		Job j2 = new TestJobObject(20, "J2", 50l);
//		sched.startExecute(0);
//		sched.enqueue(j1);
//		sched.enqueue(j2);
//		assertEquals("No threads should exist yet", 0, sched.getWorkerThreads().length);
//		sched.startOneShotWorkerThread();
//		
//		ResumePoint p = new ResumePoint() {public void resume() {}};
//		int timeout = 6000;
...
//		SchedulerServiceImpl sched = new SchedulerServiceImpl();
//		Job j1 = new TestJobObject(100, "J1");
//		Job j2 = new TestJobObject(5, "J2");
//		sched.startExecute(1);
//		sched.enqueue(j1);
//		sched.enqueue(j2);
//		WorkerThread t1 = sched.getWorkerThreads()[0];
